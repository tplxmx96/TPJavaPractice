 ...
 */
public class RadomAccessFileDemo {
    private static final String FilePath1 = "src/io/github/tplxmx96/chapter13/objectflow/Randfile.txt";
    private static final String FilePath2 = "src/io/github/tplxmx96/chapter13/objectflow/163.txt";


    /**
     * 使用RandAccessFile 实现文件的复制
     */
...
//            randFile.seek(4 * 800); //移动到第800个字符处
